...
<html class="fixed">
	<head>
		...
		<title>Form Validation | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
					...
					<div class="row">
						<div class="col-lg-6">
							<form id="form" action="forms-validation.php" class="form-horizontal">
								<section class="card">
						...
						<!-- col-lg-6 -->
						<div class="col-lg-6">
							<form id="chk-radios-form" action="forms-validation.php">
								<section class="card">
									<header class="card-header">
										<div class="card-actions">
											<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
									...
									<div class="card-body">
										<div class="form-group row">
											<label class="col-sm-3 control-label text-sm-right pt-2">Porto Admin is <span class="required">*</span></label>
											<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-lg-6">
							<form id="summary-form" action="forms-validation.php" class="form-horizontal">
								<section class="card">
									<header class="card-header">
										<div class="card-actions">
											<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
						...
						<div class="col-lg-6">
							<form id="selects-form" action="forms-validation.php">
								<section class="card">
									<header class="card-header">
										<div class="card-actions">
											<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
									...
									<div class="card-body">
										<div class="form-group row">
											<label class="col-sm-3 control-label text-sm-right pt-2">Company</label>
											<div class="col-sm-9">
										...
										<div class="form-group row">
											<label class="col-sm-3 control-label text-sm-right pt-2">Browsers</label>
											<div class="col-sm-9">
