...
<html class="left-sidebar-panel">
	<head>
		...
		<title>Left Sidebar Panel Dark Layout | Porto Admin - Responsive HTML5 Template 2.2.0</title>
			...
			<div class="inner-wrapper">
				            ...
				            <nav id="menu" class="nav-main" role="navigation">
				                ...
				                <ul class="nav nav-main">
				                        ...
				                        <ul class="nav nav-children">
				                            ...
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    ...
				                                    <li>
				                                        <a href="layouts-boxed-fixed-header.php">
				                                            Fixed Header
				                                        </a>
				                                    </li>
				                                </ul>
				                            ...
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    ...
				                                    <li>
				                                        <a href="layouts-header-menu-stripe.php">
				                                            Stripe
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="layouts-header-menu-top-line.php">
				                                            Top Line
				                                        </a>
				                                    </li>
				                                </ul>
				                            ...
				                            <li>
				                                <a href="layouts-dark.php">
				                                    Dark
				                                </a>
				                            </li>
				                            <li>
				                                <a href="layouts-dark-header.php">
				                                    Dark Header
				                                </a>
				                            </li>
				                            <li>
				                                <a href="layouts-two-navigations.php">
				                                    Two Navigations
				                                </a>
				                            </li>
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    <li>
				                                        <a href="layouts-tab-navigation-dark.php">
				                                            Tab Navigation Dark
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="layouts-tab-navigation.php">
				                                            Tab Navigation Light
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="layouts-tab-navigation-boxed.php">
				                            ...
				                            <li>
				                                <a href="layouts-light-sidebar.php">
				                                    Light Sidebar
				                                </a>
				                            </li>
				                            <li>
				                                <a href="layouts-left-sidebar-collapsed.php">
				                                    Left Sidebar Collapsed
				                                </a>
				                            </li>
				                            <li>
				                                <a href="layouts-left-sidebar-scroll.php">
				                                    Left Sidebar Scroll
				                                </a>
				                            </li>
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    <li>
				                                        <a href="layouts-left-sidebar-big-icons.php">
				                                            Left Sidebar Big Icons Dark
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="layouts-left-sidebar-big-icons-light.php">
				                            ...
				                            <li class="nav-parent nav-expanded nav-active">
				                                ...
				                                <ul class="nav nav-children">
				                                    <li class="nav-active">
				                                        <a href="layouts-left-sidebar-panel.php">
				                                            Left Sidebar Panel Dark
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="layouts-left-sidebar-panel-light.php">
				                            ...
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    <li>
				                                        <a href="layouts-sidebar-sizes-xs.php">
				                                            Left Sidebar XS
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="layouts-sidebar-sizes-sm.php">
				                                            Left Sidebar SM
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="layouts-sidebar-sizes-md.php">
				                                            Left Sidebar MD
				                                        </a>
				                                    </li>
				                                </ul>
				                            ...
				                            <li>
				                                <a href="layouts-square-borders.php">
				                                    Square Borders
				                                </a>
				                            </li>
				                        </ul>
				                    ...
				                    <li class="nav-parent">
				                        ...
				                        <ul class="nav nav-children">
				                            ...
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    <li>
				                                        <a href="ui-elements-icons-elusive.php">
				                                            Elusive
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="ui-elements-icons-font-awesome.php">
				                                            Font Awesome
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="ui-elements-icons-line-icons.php">
				                                            Line Icons
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="ui-elements-icons-meteocons.php">
				                                            Meteocons
				                                        </a>
				                                    </li>
				                                </ul>
				                            ...
				                            <li>
				                                <a href="ui-elements-toggles.php">
				                                    Toggles
				                                </a>
				                            </li>
				                            <li>
				                            ...
				                            <li>
				                                <a href="ui-elements-scrollable.php">
				                                    Scrollable
				                                </a>
				                            </li>
				                            <li>
				                            ...
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    <li>
				                                        <a href="ui-elements-animations-appear.php">
				                                            Appear
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="ui-elements-animations-hover.php">
				                                            Hover
				                                        </a>
				                                    </li>
				                                </ul>
				                            ...
				                            <li class="nav-parent">
				                                ...
				                                <ul class="nav nav-children">
				                                    <li>
				                                        <a href="ui-elements-loading-overlay.php">
				                                            Overlay
				                                        </a>
				                                    </li>
				                                    <li>
				                                        <a href="ui-elements-loading-progress.php">
				                                            Progress
				                                        </a>
				                                    </li>
				                                </ul>
				                    ...
				                    <li class="nav-parent">
				                        ...
				                        <ul class="nav nav-children">
				                            <li>
				                                <a href="extra-changelog.php">
				                                    Changelog
				                                </a>
				                            </li>
				                            <li>
				                                <a href="extra-ajax-made-easy.php">
				                                    Ajax Made Easy
				                                </a>
				                            </li>
				                        </ul>
				...
				<section role="main" class="content-body">
					<header class="page-header page-header-left-breadcrumb">
						...
						<h2>Left Sidebar Panel Dark Layout</h2>
					</header>
