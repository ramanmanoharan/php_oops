<?php include('header.php'); ?>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
							...
							echo "<div id='div' class='alert alert-primary'><center>Product Category Added!</center></div>";
						}elseif(isset($_GET['error'])){
							echo "<div id='div' class='alert alert-warning'><center>Failed to add Product Category!</center></div>";
						} else{
							echo "";
						}
...
<script type="text/javascript">
			function formclick(){
				document.getElementById('div').style.display = "none";
										...
										<form onclick="formclick()" method="post" class="form-horizontal form-bordered form-bordered" action="product-category.php" >
...
<?php 
	...
	$sql=$fetchdata->productcategoryfetch();
...
?>
	<tr data-item-id="1">
		...
		<a href="procategory-edit.php?update=<?php echo $row['id']; ?>" class="on-default edit-row"><i class="fas fa-pencil-alt"></i></a>
		<a href="procategory-delete.php?delete=<?php echo $row['id']; ?>" class="on-default remove-row"><i class="far fa-trash-alt"></i></a>
		</td>
	</tr>
<?php } ?>										
