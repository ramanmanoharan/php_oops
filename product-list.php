...
<?php 
	...
	$sql=$fetchdata->productfetch();
	while($row= mysqli_fetch_array($sql)){
?>
	<tr data-item-id="1">
		<td><?php echo $row['title']; ?></td>
		<td><?php echo $row['description']; ?></td>
		<td><img style="width:200px;height:auto" src="product/<?php echo $row['image']; ?>"></td>
		<td><?php echo $row['category']; ?></td>
		<td class="actions">
		<a href="#" class="hidden on-editing save-row"><i class="fas fa-save"></i></a>
		<a href="#" class="hidden on-editing cancel-row"><i class="fas fa-times"></i></a>
		<a href="update-product.php?update=<?php echo $row['id']; ?>" class="on-default edit-row"><i class="fas fa-pencil-alt"></i></a>
		<a href="product-delete.php?delete=<?php echo $row['id']; ?>" class="on-default remove-row"><i class="far fa-trash-alt"></i></a>
		</td>
	</tr>
<?php } ?>										
