...
<html class="fixed">
	<head>
		...
		<title>Modals | Porto Admin - Responsive HTML5 Template 2.2.0</title>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<section class="card">
								...
								<div class="card-body">
									<a class="simple-ajax-modal btn btn-default" href="ajax/ui-elements-modals-ajax.php">Load Ajax Content</a>
								</div>
							</section>
						</div>
					</div>
