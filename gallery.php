							...
							<div class="col">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Gallery Upload</h2>
									</header>
									<div class="card-body">
									<?php if(isset($_GET['success'])){
							echo "<div id='div' class='alert alert-primary'><center>Gallery Added!</center></div>";
...
<script type="text/javascript">
			function formclick(){
				document.getElementById('div').style.display = "none";
										...
										<form onclick="formclick()" method="post" class="form-horizontal form-bordered form-bordered" action="gallery-upload.php" enctype="multipart/form-data">
									...
									<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 note-editable card-block">
													<textarea required name="content" data-plugin-markdown-editor rows="10"></textarea>
												</div>
											</div>
