							...
							<div class="col">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Product Upload</h2>
									</header>
									<div class="card-body">
									<?php if(isset($_GET['success'])){
							echo "<div id='div' class='alert alert-primary'><center>Product Added!</center></div>";
...
<script type="text/javascript">
			function formclick(){
				document.getElementById('div').style.display = "none";
										...
										<form onclick="formclick()" method="post" class="form-horizontal form-bordered form-bordered" action="product-upload.php" enctype="multipart/form-data">
