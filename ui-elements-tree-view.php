...
<html class="fixed">
	<head>
		...
		<title>Tree View | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
						...
						<div class="col-lg-6">
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">You can also use AJAX to populate the tree with HTML your server returns.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
											<h5 class="font-weight-semibold text-dark text-uppercase">HTML</h5>
											<div id="treeAjaxHTML"></div>
										</div>
										<div class="col-lg-6">
											<h5 class="font-weight-semibold text-dark text-uppercase">JSON</h5>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Checkbox icons in front of each node.</p>
								</header>
								<div class="card-body">
									<div id="treeCheckbox">
										<ul>
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Makes it possible to drag and drop tree nodes and rearrange the tree.</p>
								</header>
								<div class="card-body">
									<div id="treeDragDrop">
										<ul>
		...
		<!-- Examples -->
		<script src="js/examples/examples.treeview.js"></script>
	</body>
</html>