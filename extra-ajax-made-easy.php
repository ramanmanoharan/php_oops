...
<html class="fixed">
	<head>
		...
		<title>Ajax Made Easy | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
					...
					<div class="row">
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Get Content on Page load</h2>
								</header>
								<div class="card-body" data-loading-overlay data-loading-overlay-options='{ "startShowing": true }' style="min-height: 150px;" ic-get-from="/example-lazy-load" ic-trigger-on="load">
								</div>
							</section>
						</div>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									<div class="card-actions">
										<a id="ListenOnExample" href="#" class="card-action fas fa-sync" ic-get-from="/example-refresh" ic-target="#ExampleRefreshTarget"></a>
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
									</div>

									<h2 class="card-title">Refresh Content</h2>
								</header>
								<div id="ExampleRefreshTarget" class="card-body" data-loading-overlay data-loading-overlay-options='{ "listenOn": "#ListenOnExample" }' style="min-height: 150px;">
					...
					<div class="row">
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									<div class="card-actions">
										<a href="#" class="card-action fas fa-sync" ic-trigger-on="click" ic-prepend-from="/example-load-more" ic-target="#ExampleLoadMorePrependTarget"></a>
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
									</div>

									<h2 class="card-title">Prepend Content</h2>
								</header>
								<div id="ExampleLoadMorePrependTarget" class="card-body" style="min-height: 150px;">
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									<div class="card-actions">
										<a href="#" class="card-action fas fa-sync" ic-trigger-on="click" ic-append-from="/example-load-more" ic-target="#ExampleLoadMoreAppendTarget"></a>
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
									</div>

									<h2 class="card-title">Append Content</h2>
								</header>
								<div id="ExampleLoadMoreAppendTarget" class="card-body" style="min-height: 150px;">
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Polling Content</h2>
								</header>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Scrollable - End scroll</h2>
								</header>
								<div class="card-body">
		...
		<script src="vendor/intercooler-js/intercooler.js"></script>
		...
		-->
		<script src="js/examples/examples.ajax.made.easy.js"></script>
	</body>
</html>