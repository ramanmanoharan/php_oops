...
<html class="fixed">
	<head>
		...
		<title>Vector Maps | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<link rel="stylesheet" href="vendor/jqvmap/jqvmap.css" />
	...
	<body>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Oceania</h2>
								</header>
								<div class="card-body">
		...
		<!-- Examples -->
		<script src="js/examples/examples.vector.maps.js"></script>
	</body>
</html>