...
<html class="fixed">
	<head>
		...
		<title>Font Awesome Icons | Porto Admin - Responsive HTML5 Template 2.2.0</title>
				...
				<section role="main" class="content-body icons-demo-page">
					...
					<section class="card">
						<header class="card-header">
							...
							<h2 class="card-title">Font Awesome 5 Free</h2>
						</header>
						<div class="card-body pl-5 pr-5">
							<div class="row">
								<p class="mt-3">Porto Admin uses Font Awesome for most of the icons, the comple list can be found in this link: <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank">https://fontawesome.com/icons?d=gallery&m=free</a>.</p>
							</div>
						</div>
					</section>
					<!-- end: page -->
