...
<html class="fixed">
	<head>
		...
		<title>Lightbox | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Single Image</h2>
									<p class="card-subtitle">Three simple popups with different scaling settings.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-md-4">
											<h5 class="font-weight-semibold text-dark text-uppercase">Default</h5>
											<a href="img/projects/project.jpg" data-plugin-lightbox data-plugin-options='{ "type":"image" }' title="Caption. Can be aligned it to any side and contain any HTML.">
												<img class="img-fluid" src="img/projects/project.jpg" width="145">
											</a>
										</div>
										<div class="col-md-4">
											<h5 class="font-weight-semibold text-dark text-uppercase">Fits (Horz/Vert)</h5>
											<a class="image-popup-vertical-fit" href="img/projects/project-1.jpg" title="Caption. Can be aligned it to any side and contain any HTML.">
												<img class="img-fluid" src="img/projects/project-1.jpg"  width="145">
											</a>
										</div>
										<div class="col-md-4">
											<h5 class="font-weight-semibold text-dark text-uppercase">Effects</h5>
											<a class="image-popup-no-margins" href="img/projects/project-2.jpg">
												<img class="img-fluid" src="img/projects/project-2.jpg" width="75">
											</a>
											<p class="pt-4">No gaps, zoom animation, close icon in top-right corner.</p>
										</div>
									</div>
								</div>
							</section>
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Dialog with CSS animation</h2>
									<p class="card-subtitle">Animations are added with simple CSS transitions, you can make them look however you wish.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
											<a class="mt-1 mb-1 mr-1 popup-with-zoom-anim btn ws-normal btn-default" href="#small-dialog">Open with fade-zoom animation</a>
										</div>
										<div class="col-lg-6">
											<a class="mt-1 mb-1 popup-with-move-anim btn ws-normal btn-default" href="#small-dialog">Open with fade-slide animation</a>
										</div>
									</div>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Popup with video or map</h2>
									<p class="card-subtitle">In this example lightboxes are automatically disabled on small screen size and default behavior of link is triggered.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-md-4">
											<a class="mt-1 mb-1 mr-1 popup-youtube btn btn-default" href="http://www.youtube.com/watch?v=0O2aH4XLbto">Open YouTube Video</a>
										</div>
										<div class="col-md-4">
											<a class="mt-1 mb-1 mr-1 popup-vimeo btn btn-default" href="https://vimeo.com/45830194">Open Vimeo Video</a>
										</div>
										<div class="col-md-4">
											<a class="mt-1 mb-1 popup-gmaps btn btn-default" href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom">Open Google Map</a>
										</div>
									</div>
									<hr>
									<div class="row">
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">You have full control of what is displayed in popup, align it to any side via CSS, enable or disable scroll on right side of window.</p>
								</header>
								<div class="card-body">
									<a class="simple-ajax-popup btn btn-default" href="ajax/ui-elements-lightbox-ajax.php">Load Ajax Content</a>
								</div>
							</section>
						</div>
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Check the examples file <code>examples.lightbox.js</code> for more information.</p>
								</header>
								<div class="card-body">
									<p class="pb-4">You may put any HTML content in each gallery item and mix content types. In this example lazy-loading of images is enabled for the next image based on move direction.</p>
									<div class="popup-gallery">
										<a class="float-left mb-1 mr-1" href="img/projects/project.jpg" title="Project 1">
											<div class="img-fluid">
												<img src="img/projects/project.jpg" width="105">
											</div>
										</a>
										<a class="float-left mb-1 mr-1" href="img/projects/project-1.jpg" title="Project 2">
											<div class="img-fluid">
												<img src="img/projects/project-1.jpg" width="105">
											</div>
										</a>
										<a class="float-left mb-1 mr-1" href="img/projects/project-2.jpg" title="Project 3">
											<div class="img-fluid">
												<img src="img/projects/project-2.jpg" width="105">
											</div>
										</a>
										<a class="float-left mb-1 mr-1" href="img/projects/project-3.jpg" title="Project 4">
											<div class="img-fluid">
												<img src="img/projects/project-3.jpg" width="105">
											</div>
										</a>
										<a class="float-left mb-1 mr-1" href="img/projects/project-4.jpg" title="Project 5">
											<div class="img-fluid">
												<img src="img/projects/project-4.jpg" width="105">
											</div>
										</a>
										<a class="float-left mb-1 mr-1" href="img/projects/project-5.jpg" title="Project 6">
											<div class="img-fluid">
												<img src="img/projects/project-5.jpg" width="105">
											</div>
										</a>
									</div>
								</div>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Zoom Gallery</h2>
									<p class="card-subtitle">Zoom effect works only with images.</p>
								</header>
								<div class="card-body">
									<div class="zoom-gallery">
										<a class="float-left mb-1 mr-1" href="img/projects/project.jpg" title="Project 1"><img class="img-fluid" src="img/projects/project.jpg" width="275"></a>
										<a class="float-left mb-1 mr-1" href="img/projects/project-1.jpg" title="Project 2"><img class="img-fluid" src="img/projects/project-1.jpg" width="275"></a>
									</div>
								</div>
							</section>
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Entered data is not lost if you open and close the popup or if you go to another page and then press back browser button.</p>
								</header>
								<div class="card-body">
									...
									<form id="demo-form" class="white-popup-block mfp-hide form-horizontal">
										<div class="row">
											<div class="col-sm-12">
												<h3>Basic Form</h3>
												<p class="mb-3">Entered data is not lost if you open and close the popup or if you go to another page and then press back browser button.</p>
											</div>
										</div>
		...
		<!-- Examples -->
		<script src="js/examples/examples.lightbox.js"></script>
	</body>
</html>