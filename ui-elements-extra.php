...
<html class="fixed">
	<head>
		...
		<title>Extra | Porto Admin - Responsive HTML5 Template 2.2.0</title>
						...
						<div class="col">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Arrows</h2>
									<p class="card-subtitle">Arrows can be used to highlight other elements.</p>
								</header>
								<div class="card-body">
						...
						<div class="col">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Responsive embed</h2>
									<p class="card-subtitle">Allow browsers to determine video or slideshow dimensions based on the width of their containing block by creating an intrinsic ratio that will properly scale on any device.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-8">
