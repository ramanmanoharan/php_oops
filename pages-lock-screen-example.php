...
<html class="fixed">
	<head>
		...
		<title>Lock Screen | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					You can use a lockscreen page (<a href="/pages/lock-screen.php">here</a>),
		...
		<script src="vendor/jquery-idletimer/idle-timer.js"></script>
		...
		<!-- Examples -->
		<script src="js/examples/examples.lockscreen.js"></script>
	</body>
</html>