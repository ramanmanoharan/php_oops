...
<html class="fixed">
	<head>
		...
		<title>Basic Maps | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Basic with Markers</h2>
								</header>
								<div class="card-body">
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">With Context Menu</h2>
								</header>
								<div class="card-body">
		...
		<!-- Examples -->
		<script src="js/examples/examples.gmap.js"></script>
	</body>
</html>