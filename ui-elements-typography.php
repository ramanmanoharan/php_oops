...
<html class="fixed">
	<head>
		...
		<title>Typography | Porto Admin - Responsive HTML5 Template 2.2.0</title>
						...
						<div class="col-lg-9">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">All HTML headings, <code>&lt;h1&gt;</code> through <code>&lt;h6&gt;</code>, are available.</p>
								</header>
								<div class="card-body">
									<h1>h1. Heading 1</h1>
									<h2>h2. Heading 2</h2>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Paragraphs</h2>
									<p class="card-subtitle">Make a paragraph stand out by adding lead class, and check out the alternative font style.</p>
								</header>
								<div class="card-body">
									<p class="lead">Mauris aliquet ultricies ante, non <span class="wort-rotator" data-plugin-options='{ "delay": 3000 }'><span class="wort-rotator-items"><span>lorem</span>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Alignments</h2>
									<p class="card-subtitle">It's easy to align the text the way you want</p>
								</header>
								<div class="card-body">
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Text styles/states can be changed with css classes.</p>
								</header>
								<div class="card-body">
									<p class="text-muted">
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Drop Caps</h2>
									<p class="card-subtitle">Dropcaps styles can be changed with css classes.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Blockquote styles can be changed with css classes.</p>
								</header>
								<div class="card-body">
									<blockquote>
						...
						<div class="col-lg-3">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Unordered List</h2>
									<p class="card-subtitle">A list of items in which the order does not explicitly matter.</p>
								</header>
								<div class="card-body">
									<ul>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Ordered List</h2>
									<p class="card-subtitle">A list of items in which the order does explicitly matter.</p>
								</header>
								<div class="card-body">
									<ol>
										<li>Lorem ipsum dolor sit amet.</li>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Unstyled List</h2>
									<p class="card-subtitle">Remove the default list-style and left margin on list items (immediate children only).</p>
								</header>
								<div class="card-body">
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Inline List</h2>
									<p class="card-subtitle">Place all list items on a single line with display: inline-block; and some light padding.</p>
								</header>
								<div class="card-body">
