...
<html class="fixed">
	<head>
		...
		<title>Portlets | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<h4 class="mt-0 mb-1">Portlets</h4>
					<p>
						Here you can drag and drop cards. Their state is automatically saved, refresh to restore the saved state.
					</p>
					<p>
						<button id="portletRefresh" type="button" class="mb-1 mt-1 mr-1 btn btn-default"><i class="fas fa-sync"></i> Refresh</button>
						<button id="portletReset" type="button" class="mb-1 mt-1 mr-1 btn btn-default"><i class="fas fa-undo"></i> Reset</button>
					</p>

					<div class="row">
						<div class="col-lg-4" data-plugin-portlet id="portlet-1">
							...
							<section class="card card-secondary" id="card-2" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
							...
							<section class="card card-tertiary" id="card-3" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
						...
						<div class="col-lg-4" data-plugin-portlet id="portlet-2">
							<section class="card card-quaternary" id="card-4" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
							...
							<section class="card card-primary" id="card-5" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
							...
							<section class="card card-secondary" id="card-6" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
						...
						<div class="col-lg-4" data-plugin-portlet id="portlet-3">
							<section class="card card-tertiary" id="card-7" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
							...
							<section class="card card-secondary" id="card-8" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
							...
							<section class="card card-danger" id="card-9" data-portlet-item>
								<header class="card-header portlet-handler">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
		...
		<script src="vendor/store2/store2.js"></script>
		...
		<!-- Examples -->
		<script src="js/examples/examples.portlets.js"></script>
	</body>
</html>