...
<html class="fixed">
	<head>
		...
		<title>Grid System | Porto Admin - Responsive HTML5 Template 2.2.0</title>
						...
						<div class="col-md-12">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Bootstrap includes a responsive, mobile first fluid grid system that appropriately scales up to 12 columns as the device or viewport size increases. Learn more: <a href="http://getbootstrap.com/css/#grid" target="_blank">http://getbootstrap.com/css/#grid</a>.</p>
								</header>
								<div class="card-body">
