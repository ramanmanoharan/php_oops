...
<html class="fixed has-top-menu has-left-sidebar-half">
	<head>
		...
		<title>Two Navigations Layout | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<header class="header header-nav-menu">
				...
				<div class="header-right">
					...
					<form action="pages-search-results.php" class="search nav-form d-none d-xl-inline-block">
