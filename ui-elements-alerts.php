...
<html class="fixed">
	<head>
		...
		<title>Alerts | Porto Admin - Responsive HTML5 Template 2.2.0</title>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.</p>
								</header>
								<div class="card-body">
						...
						<div class="col-lg-6">
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Add small overlays of content, like those on the iPad, to any element for housing secondary information.</p>
								</header>
								<div class="card-body">
