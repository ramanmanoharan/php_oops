...
?>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
							...
							echo "<div id='div' class='alert alert-primary'><center>Services Updated!</center></div>";
...
<script type="text/javascript">
			function formclick(){
				document.getElementById('div').style.display = "none";
										...
										<form onclick="formclick()" method="post" class="form-horizontal form-bordered form-bordered" action="service-update.php" enctype="multipart/form-data">
									...
									<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 note-editable card-block">
													<textarea required class="ckeditor" name="content"  rows="10"><?php echo $row['description']; ?></textarea>
													<!-- <textarea  required name="content"  rows="10"></textarea> -->
												</div>
											</div>
