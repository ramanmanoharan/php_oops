...
<html class="fixed">
	<head>
		...
		<title>Basic Tables | Porto Admin - Responsive HTML5 Template 2.2.0</title>
							...
							<div class="col-lg-6">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Hover Rows</h2>
									</header>
									<div class="card-body">
							...
							<div class="col-lg-6">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Actions Hover</h2>
									</header>
									<div class="card-body">
										<table class="table table-responsive-md mb-0">
											<thead>
							...
							<div class="col-lg-6">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Actions Hover with fade</h2>
									</header>
									<div class="card-body">
										<table class="table table-responsive-md mb-0">
											<thead>
							...
							<div class="col-lg-6">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Hover Rows + Actions Hover with Fade</h2>
									</header>
									<div class="card-body">
										<table class="table table-responsive-md table-hover mb-0">
											<thead>
