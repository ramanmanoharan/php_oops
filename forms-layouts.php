...
<html class="fixed">
	<head>
		...
		<title>Form Layouts | Porto Admin - Responsive HTML5 Template 2.2.0</title>
								...
								<section class="card">
									...
									<div class="card-body">
										<div class="form-group row">
											<label class="col-sm-4 control-label text-sm-right pt-2">Your Name: </label>
											<div class="col-sm-8">
												<input type="text" name="name" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label text-sm-right pt-2">Your Email: </label>
											<div class="col-sm-8">
							...
							<form id="form2" class="form-horizontal form-bordered">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Bordered Form</h2>
							...
							<form>
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Form without labels</h2>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Multi-Column Form</h2>
						...
						<div class="col-lg-12">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Inline Form</h2>
									<p class="card-subtitle">
