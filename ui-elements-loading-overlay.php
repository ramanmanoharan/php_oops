...
<html class="fixed">
	<head>
		...
		<title>Overlay | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<h4 class="mt-0 mb-0">Loading Overlay</h4>
							...
							<div class="mb-3">
								<code>
									&lt;div class=&quot;loading-overlay&quot;&gt;<br/>
										&nbsp;&nbsp;&nbsp;&nbsp;&lt;div class=&quot;bounce-loader&quot;&gt;<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div class=&quot;bounce1&quot;&gt;&lt;/div&gt;<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div class=&quot;bounce2&quot;&gt;&lt;/div&gt;<br/>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Using on a Panel</h2>
								</header>
								<div class="card-body" data-loading-overlay data-loading-overlay-options='{ "startShowing": true }' style="min-height: 150px;">
									Content.
								</div>
							</section>
						</div>
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Custom Options</h2>
								</header>
								<div class="card-body" data-loading-overlay data-loading-overlay-options='{ "startShowing": true, "css": { "backgroundColor": "#0088cc" } }' style="min-height: 150px;">
									Content.
								</div>
							</section>
						</div>
						...
						<div class="col-md-12">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Loading Overlay API</h2>
								</header>
								<div class="card-body">

									<div class="row">
										<div class="col-lg-4 center mb-3 mb-lg-0">
											<button id="ApiShowOverlay" class="btn btn-primary mt-3">Show Overlay</button>
										</div>
										<div class="col-lg-4 center">
											<div style="background-color: #FFF; border: 1px solid #DDD;  line-height: 80px; height: 80px; margin: 0 auto; text-align: center; width: 180px;" id="LoadingOverlayApi" data-loading-overlay>
												Content
											</div>
										</div>
										<div class="col-lg-4 center">
											<button id="ApiHideOverlay" class="btn btn-primary mt-3">Hide Overlay</button>
										</div>
									</div>

									<!--
									See: js/examples/examples.loading.overlay.js for usage instructions.
									-->
								</div>
							</section>
						</div>
