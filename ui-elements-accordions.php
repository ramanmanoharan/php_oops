...
<html class="fixed">
	<head>
		...
		<title>Accordions | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
						...
						<div class="col-lg-6 col-xl-3">
							<div class="accordion accordion-secondary" id="accordion2Secondary">
								<div class="card card-default">
									...
									<div id="collapse2SecondaryOne" class="collapse show">
										<div class="card-body">
											<p>Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.</p>
										</div>
									</div>
								...
								<div class="card card-default">
									...
									<div id="collapse2SecondaryThree" class="collapse">
										<div class="card-body">
											<p>Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.</p>
										</div>
									</div>
						...
						<div class="col-lg-6 col-xl-3">
							<div class="accordion accordion-tertiary" id="accordion2Tertiary">
								<div class="card card-default">
									...
									<div id="collapse2TertiaryOne" class="collapse show">
										<div class="card-body">
											<p>Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.</p>
										</div>
									</div>
								...
								<div class="card card-default">
									...
									<div id="collapse2TertiaryTwo" class="collapse">
										<div class="card-body">
											<p>Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.</p>
										</div>
									</div>
						...
						<div class="col-lg-6 col-xl-3">
							<div class="accordion accordion-quaternary" id="accordion2Quaternary">
								<div class="card card-default">
									...
									<div id="collapse2QuaternaryOne" class="collapse show">
										<div class="card-body">
											<p>Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.</p>
										</div>
									</div>
								...
								<div class="card card-default">
									...
									<div id="collapse2QuaternaryTwo" class="collapse">
										<div class="card-body">
											<p>Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.</p>
										</div>
									</div>
								...
								<div class="card card-default">
									...
									<div id="collapse2QuaternaryThree" class="collapse">
										<div class="card-body">
											<p>Donec tellus massa, tristique sit amet condimentum vel, facilisis quis sapien.</p>
										</div>
									</div>
					...
					<div class="row">						
						<div class="col-lg-6 col-xl-3 mb-3 mb-lg-0">
							<h4>Small</h4>
								...
								<div class="card card-default">
									...
									<div id="collapse5One" class="collapse show">
										<div class="card-body">
											...
											<img class="pull-left" width="150" height="106" src="img/device.png" alt="">
