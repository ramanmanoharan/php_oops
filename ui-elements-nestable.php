...
<html class="fixed">
	<head>
		...
		<title>Nestable | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
						...
						<div class="col">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Nestable List</h2>
									<p class="card-subtitle">Drag & drop hierarchical list with mouse and touch compatibility.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
		...
		<!-- Examples -->
		<script src="js/examples/examples.nestable.js"></script>
	</body>
</html>