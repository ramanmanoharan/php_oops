...
<html class="fixed">
	<head>
		...
		<title>Cards | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<h4 class="mt-0 mb-0">Basic</h4>
					<p class="mb-3">By default, all the <code>.panel</code> does is apply some basic border and padding to contain some content.</p>
					...
					<h4 class="pt-4 mb-0 mt-0">Panel with Heading</h4>
					<p class="mb-3">Easily add a heading container to your panel with <code>.card-header</code>. You may also include any <code>h1</code> - <code>h6</code> with a <code>.card-title</code> class to add a pre-styled heading.</p>
					...
					<h4 class="mb-0">Panel with Footer</h4>
					<p class="mb-3">Wrap buttons or secondary text in <code>.card-footer</code>. Note that panel footers do not inherit colors and borders when using contextual variations as they are not meant to be in the foreground.</p>
					...
					<h4 class="pt-3 mb-0">Panel Collapsed by Default</h4>
					<p class="mb-3">Add <code>.card-collapsed</code> class to the panel.</p>
					<div class="row">
						<div class="col-md-6">
							<section class="card card-collapsed mb-4">
								<header class="card-header">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
					...
					<h4 class="pt-3 mb-0">Panel Featured</h4>
					<p class="mb-3">Like other components, easily make a panel more meaningful to a particular context by adding any of the contextual state classes.</p>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<section class="card card-featured card-featured-success mb-4">
								...
								<div class="card-body">
									<code>.card-featured.card-featured-success</code>
								</div>
							</section>
						</div>
						...
						<div class="col-md-6">
							<section class="card card-featured card-featured-warning mb-4">
								...
								<div class="card-body">
									<code>.card-featured.card-featured-warning</code>
								</div>
							</section>
						</div>
						...
						<div class="col-md-6">
							<section class="card card-featured card-featured-danger mb-4">
								<header class="card-header">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
								...
								<div class="card-body">
									<code>.card-featured.card-featured-danger</code>
								</div>
							</section>
						</div>
						...
						<div class="col-md-6">
							<section class="card card-featured card-featured-info mb-4">
								...
								<div class="card-body">
									<code>.card-featured.card-featured-info</code>
								</div>
							</section>
						</div>
						...
						<div class="col-md-6">
							<section class="card card-featured card-featured-dark mb-4">
								...
								<div class="card-body">
									<code>.card-featured.card-featured-dark</code>
								</div>
							</section>
						</div>
					...
					<h4 class="pt-3 mb-0">Contextual Alternatives</h4>
					<p class="mb-3">Like other components, easily make a panel more meaningful to a particular context by adding any of the contextual state classes.</p>
					...
					<h4 class="mb-0">Panel Transparent</h4>
					<p class="mb-3">Set the panel to transparent background.</p>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<section class="card card-transparent mb-4">
								<header class="card-header">
									<div class="card-actions">
										<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
