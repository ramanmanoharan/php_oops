...
<html class="fixed">
	<head>
		...
		<title>Scrollable | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<h4 class="mb-0">Scrollable Content</h4>
					<p class="mb-3">Easily add scrollbars in any type of content in the page as shown below:</p>
						...
						<div class="col-lg-4">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Panel with Scrollable Content</h2>
								</header>
								<div class="card-body">
						...
						<div class="col-lg-4">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Slider Always Visible</h2>
								</header>
								<div class="card-body">
						...
						<div class="col-lg-4">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Slider Always Visible and Colored</h2>
								</header>
								<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h4 class="mb-3">Scrollable Content + Nested Container</h4>
