		...
		<section class="body-sign">
			<div class="center-sign">
				<a href="/" class="logo float-left">
					<img src="https://bluesaquarium.com/aquarium1.png" height="54" alt="Blues Admin" />
				</a>
				...
				<div class="panel card-sign">
					...
					<div class="card-body">
						<?php if(isset($_GET['error'])){
							echo "<div id='div' class='alert alert-warning'><center>USER NAME OR PASSORD ERROR!</center></div>";
						} ?>
						<form onclick="formclick()" action="action.php" method="post">
...
<!-- 
							...
							<p class="text-center">Don't have an account yet? <a href="pages-signup.php">Sign Up!</a></p> -->
