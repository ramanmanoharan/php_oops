...
<html class="fixed sidebar-left-collapsed sidebar-left-with-menu">
	<head>
		...
		<title>Map Builder | Porto Admin - Responsive HTML5 Template 2.2.0</title>
									...
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="longitude">Map #ID</label>
													<div class="col-sm-12">
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="latitude">Latitude</label>
													<div class="col-sm-12">
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="longitude">Longitude</label>
													<div class="col-sm-12">
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="zoomLevel">Zoom Level</label>
													<div class="col-sm-12">
														<select id="zoomLevel" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="zoomlevel">
											...
											<div class="form-group">
												...
												<div class="row">
													<div class="col-sm-6">
														<button class="btn btn-primary btn-block mb-3" type="button" data-toggle="modal" data-target="#MarkerModal">Add</button>
													</div>
													<div class="col-sm-6">
														<button id="MarkerRemoveAll" class="btn btn-danger btn-block mb-3" type="button">Remove All</button>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="maptypecontrol">Map Type Control</label>
													<div class="col-sm-12">
														<select id="maptypecontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="maptypecontrol">
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="zoomcontrol">Zoom Control</label>
													<div class="col-sm-12">
														<select id="zoomcontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="zoomcontrol">
															<option value="false">None</option>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="scalecontrol">Scale Control</label>
													<div class="col-sm-12">
														<select id="scalecontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="scalecontrol">
															<option value="false">None</option>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="streeviewcontrol">Stree View Control</label>
													<div class="col-sm-12">
														<select id="streeviewcontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="streetviewcontrol">
															<option value="false">None</option>
															<option selected="selected" value="true">Standard</option>
														</select>
													</div>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="pancontrol">Pan Control</label>
													<div class="col-sm-12">
														<select id="pancontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="pancontrol">
															<option value="false">None</option>
															<option selected="selected" value="true">Standard</option>
														</select>
													</div>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="overviewcontrol">Overview Control</label>
													<div class="col-sm-12">
														<select id="overviewcontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="overviewcontrol">
															<option value="false">None</option>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="draggablecontrol">Draggable Control</label>
													<div class="col-sm-12">
														<select id="draggablecontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="draggablecontrol">
															<option value="false">None</option>
															<option selected="selected" value="true">Standard</option>
														</select>
													</div>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="clickzoomcontrol">Double Click to Zoom</label>
													<div class="col-sm-12">
														<select id="clickzoomcontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="clicktozoomcontrol">
															<option value="false">None</option>
															<option selected="selected" value="true">Standard</option>
														</select>
													</div>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="scrollwheelcontrol">Mouse Wheel to Zoom</label>
													<div class="col-sm-12">
														<select id="scrollwheelcontrol" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="scrollwheelcontrol">
															<option value="false">None</option>
															<option selected="selected" value="true">Standard</option>
														</select>
													</div>
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="maptype">Map Type</label>
													<div class="col-sm-12">
														<select id="maptype" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="maptype">
											...
											<div class="form-group">
												<div class="row">
													<label class="col-sm-12 control-label" for="maptheme">Map Theme</label>
													<div class="col-sm-12">
														<select id="maptheme" class="form-control mb-3" data-plugin-selectTwo data-plugin-options='{ "minimumResultsForSearch": -1 }' data-builder-field="maptheme">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-sm-6">
														<button class="btn btn-primary btn-block mb-3" type="button" data-toggle="modal" data-target="#ModalGetCode">Get Code</button>
													</div>
													<div class="col-sm-6">
														<button class="btn btn-primary btn-block mb-3" type="button" data-toggle="modal" data-target="#ModalPreview">Preview</button>
													</div>
												</div>
											</div>
										</div>
