...
<html class="fixed">
	<head>
		...
		<title>Buttons | Porto Admin - Responsive HTML5 Template 2.2.0</title>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Use any of the available button classes to quickly create a styled <code>button</code>.</p>
								</header>
								<div class="card-body">
									<button type="button" class="mb-1 mt-1 mr-1 btn btn-default">Default</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-primary">Primary</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-success">Success</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-info">Info</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-warning">Warning</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-danger">Danger</button>
								</div>
							</section>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Disabled Buttons</h2>
									<p class="card-subtitle">Add the <code>disabled</code> attribute to <code>&lt;button&gt;</code> buttons.</p>
								</header>
								<div class="card-body">
									<button type="button" class="mb-1 mt-1 mr-1 btn btn-default" disabled>Default</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-primary" disabled>Primary</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-success" disabled>Success</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-info" disabled>Info</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-warning" disabled>Warning</button>

									<button type="button" class="mb-1 mt-1 mr-1 btn btn-danger" disabled>Danger</button>
								</div>
							</section>
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Fancy larger or smaller buttons? Add <code>.btn-lg</code>, <code>.btn-sm</code>, or <code>.btn-xs</code> for additional sizes.</p>
								</header>
								<div class="card-body">
									<p class="m-0">
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-lg btn-default">Large Button</button>
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-lg btn-primary">Large Button</button>
									</p>
									<p class="m-0">
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-default">Default Button</button>
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-primary">Default Button</button>
									</p>
									<p class="m-0">
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-sm btn-default">Small Button</button>
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-sm btn-primary">Small Button</button>
									</p>
									<p class="m-0">
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-xs btn-default">Extra Small Button</button>
										<button type="button" class="mb-1 mt-1 mr-1 btn btn-xs btn-primary">Extra Small Button</button>
									</p>
								</div>
							</section>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Dropdowns</h2>
									<p class="card-subtitle">Turn a button into a dropdown toggle with some basic markup changes.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
											<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Dropdown</h5>
											<p>Simple Dropdown Menus.</p>
											<div class="btn-group flex-wrap">
												<button type="button" class="mb-1 mt-1 mr-1 btn btn-default dropdown-toggle" data-toggle="dropdown">Default <span class="caret"></span></button>
										...
										<div class="col-lg-6">
											<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Dropup</h5>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Buttons Icons</h2>
									<p class="card-subtitle">It's easy to add a icon from the library to a button.</p>
								</header>
								<div class="card-body">
									<button type="button" class="mb-1 mt-1 mr-1 btn btn-default"><i class="fas fa-sync"></i> Refresh</button>
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Create block level buttons—those that span the full width of a parent— by adding <code>.btn-block</code>.</p>
								</header>
								<div class="card-body">
									<button type="button" class="mb-1 mt-1 mr-1 btn btn-primary btn-lg btn-block">Block level button</button>
									<button type="button" class="mb-1 mt-1 mr-1 btn btn-default btn-lg btn-block">Block level button</button>
									<button type="button" class="mb-1 mt-1 mr-1 btn btn-primary btn-block">Block level button</button>
									<button type="button" class="mb-1 mt-1 mr-1 btn btn-default btn-sm btn-block">Block level button</button>
								</div>
							</section>
							...
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Justified Button Groups</h2>
									<p class="card-subtitle">Make a group of buttons stretch at equal sizes to span the entire width of its parent.</p>
								</header>
								<div class="card-body">
									<div class="btn-group d-flex" role="group">
										<a class="btn btn-default w-100" role="button">Left</a>
										<a class="btn btn-default w-100" role="button">Middle</a>
										<a class="btn btn-default w-100" role="button">Right</a>
									</div>
								</div>
							</section>
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">Wrap a series of buttons with <code>.btn</code> in <code>.btn-group</code>.</p>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-md-4">
											<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Basic</h5>
											<p>Simple Group</p>
											<p>
												<div class="btn-group flex-wrap">
										...
										<div class="col-md-4">
											<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Vertical</h5>
											<p>Vertically stacked.</p>
											<p>
												<div class="btn-group-vertical flex-wrap">
													<button type="button" class="btn btn-default">Left</button>
													<button type="button" class="btn btn-default">Middle</button>
													<button type="button" class="btn btn-default">Right</button>
												</div>
										...
										<div class="col-md-4">
											<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Nesting</h5>
