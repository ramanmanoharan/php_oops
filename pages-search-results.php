...
<html class="fixed search-results">
	<head>
		...
		<title>Searching Results | Porto Admin - Responsive HTML5 Template 2.2.0</title>
				...
				<section role="main" class="content-body">
					...
					<div class="search-content">
						<div class="search-control-wrapper">
							<form action="pages-search-results.php">
							...
							<div id="everything" class="tab-pane active">
								...
								<ul class="list-unstyled search-results-list">
									<li>
										...
										<a href="pages-user-profile.php" class="has-thumb">
									...
									<li>
										...
										<a href="pages-invoice.php" class="has-thumb">
											<div class="result-thumb">
									...
									<li>
										...
										<a href="mailbox-email.php" class="has-thumb">
											<div class="result-thumb">
												<i class="fas fa-envelope"></i>
											</div>
											<div class="result-data">
