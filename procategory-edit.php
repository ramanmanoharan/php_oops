...
if(isset($_GET['update'])){
	...
	$sql = $fetchone->procatfetchone($updateid);
							...
							<div class="col">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">Product Category Update</h2>
									</header>
									<div class="card-body">
									<?php if(isset($_GET['success'])){
							echo "<div id='div' class='alert alert-primary'><center>Product Category Updated!</center></div>";
						}elseif(isset($_GET['error'])){
							echo "<div id='div' class='alert alert-warning'><center>Failed to Update Product Category!</center></div>";
						} else{
							echo "";
						}
...
<script type="text/javascript">
			function formclick(){
				document.getElementById('div').style.display = "none";
										...
										<form onclick="formclick()" method="post" class="form-horizontal form-bordered form-bordered" action="procat-update.php">
