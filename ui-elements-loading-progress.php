...
<html class="fixed">
	<head>
		...
		<title>Progress | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<h4 class="mt-0 mb-0">Loading Progress</h4>
					<p class="mb-4">Loading progress is a progress bar that can be changed via Javascript.</p>
						...
						<div class="col-md-12">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Examples of Usage</h2>
								</header>
								<div class="card-body">
									<div class="row">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-6">
													<button id="NPStart" class="btn btn-primary btn-block mt-3">Start</button>
												</div>
												<div class="col-md-6">
													<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Start the Bar</h5>
													<code>
														NProgress.start();
													</code>
												</div>
										...
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-6">
													<button id="NPStart" class="btn btn-primary btn-block mt-3">Increment</button>
												</div>
												<div class="col-md-6">
													<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Increment a little bit</h5>
													<code>
														NProgress.inc();
													</code>
												</div>
									...
									<div class="row mt-3">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-6">
													<button id="NPStart" class="btn btn-primary btn-block mt-3">0% to 100%</button>
												</div>
												<div class="col-md-6">
													<h5 class="font-weight-semibold text-dark text-uppercase mb-0">From 0% to 100%</h5>
													<code>
														NProgress.done(true);
													</code>
												</div>
										...
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-6">
													<button id="NPStart" class="btn btn-primary btn-block mt-3">Stop</button>
												</div>
												<div class="col-md-6">
													<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Stop the Bar</h5>
													<code>
														NProgress.done();
													</code>
												</div>
									...
									<div class="row mt-3">
										<div class="col-md-9">
											<button data-np-set="10" class="btn btn-primary mt-3">Set to 10</button>
											<button data-np-set="20" class="btn btn-primary mt-3">Set to 20</button>
											<button data-np-set="30" class="btn btn-primary mt-3">Set to 30</button>
											<button data-np-set="40" class="btn btn-primary mt-3">Set to 40</button>
											<button data-np-set="50" class="btn btn-primary mt-3">Set to 50</button>
											<button data-np-set="60" class="btn btn-primary mt-3">Set to 60</button>
											<button data-np-set="70" class="btn btn-primary mt-3">Set to 70</button>
											<button data-np-set="80" class="btn btn-primary mt-3">Set to 80</button>
											<button data-np-set="90" class="btn btn-primary mt-3">Set to 90</button>
										</div>
										<div class="col-md-3">
											<h5 class="font-weight-semibold text-dark text-uppercase mb-0">Set Percentual</h5>
											<code>
									...
									<div class="row mt-3">
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-3">
													<button id="NPCallbacks" class="btn btn-primary btn-block mt-3">Go</button>
												</div>
												<div class="col-md-9">
													<h5 class="font-weight-semibold text-dark text-uppercase">Set to 50 and use callbacks</h5>
													<code>
NProgress.set( 0.5, {
	<br/>
&nbsp;&nbsp;&nbsp;&nbsp;onInit: function() {
...
&nbsp;&nbsp;&nbsp;&nbsp;}
	<br/>
									...
									<!--
									See: js/examples/examples.loading.progress.js for usage instructions.
									-->
								</div>
							</section>
						</div>
		...
		<!-- Examples -->
		<script src="js/examples/examples.loading.progress.js"></script>
	</body>
</html>