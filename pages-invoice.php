...
<html class="fixed">
	<head>
		...
		<title>Invoice | Porto Admin - Responsive HTML5 Template 2.2.0</title>
					...
					<section class="card">
						<div class="card-body">
							...
							<div class="text-right mr-4">
								...
								<a href="pages-invoice-print.php" target="_blank" class="btn btn-primary ml-3"><i class="fas fa-print"></i> Print</a>
							</div>
						</div>
					</section>
