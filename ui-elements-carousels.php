...
<html class="fixed">
	<head>
		...
		<title>Carousels | Porto Admin - Responsive HTML5 Template 2.2.0</title>
						...
						<div class="col-lg-6 col-xl-3">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Autoplay</h2>
								</header>
								<div class="card-body">
						...
						<div class="col-lg-6 col-xl-3">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Controls Disabled</h2>
								</header>
								<div class="card-body">
									<div class="owl-carousel owl-theme" data-plugin-carousel data-plugin-options='{ "dots": false, "nav": false, "items": 1 }'>
										<div class="item"><img class="img-thumbnail" src="img/projects/project-1.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="img/projects/project-2.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="img/projects/project-3.jpg" alt=""></div>
									 </div>
