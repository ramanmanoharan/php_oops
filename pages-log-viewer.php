...
<html class="fixed">
	<head>
		...
		<title>Log Viewer | Porto Admin - Responsive HTML5 Template 2.2.0</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body has-toolbar">
					...
					<div class="inner-toolbar clearfix">
						<ul>
							<li>
								<button type="button" class="btn btn-primary"><i class="fas fa-pause m-0"></i> Pause</button>
							</li>
							<li class="right">
						...
						<div class="card-body tab-content">
								...
								<table class="table table-striped table-no-more table-bordered mb-0">
									<thead>
										<tr>
											...
											<th style="width: 15%"><span class="font-weight-normal text-4">Date</span></th>
									...
									<tbody class="log-viewer">
										<tr>
											<td data-title="Type" class="pt-3 pb-3">
												<i class="fas fa-bug fa-fw text-muted text-5 va-middle"></i>
										...
										<tr>
											<td data-title="Type" class="pt-3 pb-3">
												<i class="fas fa-ban fa-fw text-danger text-5 va-middle"></i>
							...
							<div id="error-log" class="tab-pane">
								<table class="table table-striped table-no-more table-bordered mb-0">
									<thead>
										<tr>
											<th style="width: 10%"><span class="font-weight-normal text-5">Type</span></th>
											<th style="width: 15%"><span class="font-weight-normal text-5">Date</span></th>
											<th><span class="font-weight-normal text-5">Message</span></th>
										</tr>
									</thead>
									<tbody class="log-viewer">
										<tr>
