...
<html class="fixed sidebar-left-collapsed sidebar-left-with-menu">
	<head>
		...
		<title>E-Mail | Porto Admin - Responsive HTML5 Template 2.2.0</title>
						...
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="email">
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											<a href="mailbox-compose.php" class="btn btn-block btn-primary btn-md pt-2 pb-2 text-3">
											...
											<ul class="list-unstyled mt-3 pt-3">
												<li>
													<a href="mailbox-folder.php" class="menu-item active">Inbox <span class="badge badge-primary font-weight-normal float-right">43</span></a>
												</li>
												<li>
							...
							<div class="inner-body mailbox-email">
								<div class="mailbox-email-header mb-3">
									...
									<p class="mt-2 mb-0 text-5">From <a href="#">Okler Themes</a> to <a href="#">You</a>, started on July, 05, 2017</p>
								</div>
									...
									<div class="mailbox-email-screen pt-4">
										<div class="card mb-3">
											<div class="card-header">
												...
												<p class="card-title">Okler Themes <i class="fas fa-angle-right fa-fw"></i> You</p>
											</div>
											<div class="card-body">
											...
											<div class="card-footer">
												<p class="m-0"><small>July 07, 2017. 9:51pm</small></p>
											</div>
										</div>
										...
										<div class="card mb-3">
											<div class="card-header">
												...
												<p class="card-title">You <i class="fas fa-angle-right fa-fw"></i> Okler Themes
											</div>
											<div class="card-body">
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer volutpat nulla et sollicitudin volutpat. Suspendisse consequat massa et varius tincidunt. In quis velit et enim posuere consectetur at et erat. Praesent condimentum ipsum non ligula tempor cursus. Maecenas ornare vitae nibh blandit suscipit. Nulla suscipit mollis dui vitae porttitor. Nulla faucibus neque leo. Sed tincidunt enim sit amet tellus bibendum consectetur. Nunc lobortis metus posuere adipiscing auctor. Duis ante ipsum, malesuada eu risus vitae, mattis dapibus arcu. Nullam metus dui, fermentum dictum nulla id, gravida dignissim eros.</p>
											...
											<div class="card-footer">
												<p class="m-0"><small>July 06, 2017. 03:26pm</small></p>
											</div>
										</div>
										...
										<div class="card mb-3">
											<div class="card-header">
												...
												<p class="card-title">Okler Themes <i class="fas fa-angle-right fa-fw"></i> You
											</div>
											<div class="card-body">
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer volutpat nulla et sollicitudin volutpat. Suspendisse consequat massa et varius tincidunt. In quis velit et enim posuere consectetur at et erat. Praesent condimentum ipsum non ligula tempor cursus. Maecenas ornare vitae nibh blandit suscipit. Nulla suscipit mollis dui vitae porttitor. Nulla faucibus neque leo. Sed tincidunt enim sit amet tellus bibendum consectetur. Nunc lobortis metus posuere adipiscing auctor. Duis ante ipsum, malesuada eu risus vitae, mattis dapibus arcu. Nullam metus dui, fermentum dictum nulla id, gravida dignissim eros.</p>
											...
											<div class="card-footer">
												<p class="m-0"><small>July 05, 2017. 10:03am</small></p>
											</div>
										</div>
									</div>
