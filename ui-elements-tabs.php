...
<html class="fixed">
	<head>
		...
		<title>Tabs | Porto Admin - Responsive HTML5 Template 2.2.0</title>
							...
							<div class="tabs">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="tabs tabs-bottom">
								...
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular13" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent13" data-toggle="tab">Recent</a>
									</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="tabs tabs-bottom tabs-primary">
								...
								<ul class="nav nav-tabs justify-content-end">
									<li class="nav-item active">
										<a class="nav-link" href="#popular14" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent14" data-toggle="tab">Recent</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="tabs">
								<ul class="nav nav-tabs nav-justified">
									<li class="nav-item active">
										<a class="nav-link" href="#popular10" data-toggle="tab" class="text-center"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent10" data-toggle="tab" class="text-center">Recent</a>
									</li>
								</ul>
								<div class="tab-content">
						...
						<div class="col-lg-6">
							<div class="tabs tabs-bottom tabs-primary">
								...
								<ul class="nav nav-tabs nav-justified">
									<li class="nav-item active">
										<a class="nav-link" href="#popular8" data-toggle="tab" class="text-center"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent8" data-toggle="tab" class="text-center">Recent</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="tabs tabs-vertical tabs-left">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular11" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
						...
						<div class="col-lg-6">
							<div class="tabs tabs-vertical tabs-right tabs-primary">
								...
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular12" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent12" data-toggle="tab">Recent</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="tabs tabs-primary">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular1" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent1" data-toggle="tab">Recent</a>
									</li>
								</ul>
								<div class="tab-content">
						...
						<div class="col-lg-6">
							<div class="tabs tabs-secondary">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular2" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent2" data-toggle="tab">Recent</a>
									</li>
								</ul>
								<div class="tab-content">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="tabs tabs-tertiary">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular3" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent3" data-toggle="tab">Recent</a>
									</li>
								</ul>
								<div class="tab-content">
						...
						<div class="col-lg-6">
							<div class="tabs tabs-quaternary">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular4" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent4" data-toggle="tab">Recent</a>
									</li>
								</ul>
								<div class="tab-content">
					...
					<div class="row">
						<div class="col">
							<div class="tabs tabs-dark">
								<ul class="nav nav-tabs">
									<li class="nav-item active">
										<a class="nav-link" href="#popular6" data-toggle="tab"><i class="fas fa-star"></i> Popular</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#recent6" data-toggle="tab">Recent</a>
									</li>
								</ul>
								<div class="tab-content">
