...
<html class="fixed">
	<head>
		...
		<title>Pricing Tables | Porto Admin - Responsive HTML5 Template 2.2.0</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row pt-0">
						<div class="col">
							<h4 class="mt-0 mb-0">Three Plans</h4>
					...
					<div class="row pt-0">
						<div class="col">
							<h4 class="mt-0 mb-0">Alternative Style</h4>
							<p>Set the table with a different style</p>
						</div>
					</div>
					...
					<div class="row pt-0">
						<div class="col">
							<h4 class="mt-3 mb-0">Small Blocks</h4>
							<p>Set the table with small blocks</p>
						</div>
					</div>

					<div class="pricing-table pricing-table-sm row no-gutters mt-3 mb-3">
						<div class="col-lg-2">
							<div class="plan">
								<h3>
									Basic
									<em class="desc"><strong>3GB</strong> Disk Space</em>
									<span>$19</span>
								</h3>
						...
						<div class="col-lg-2 text-center">
							<div class="plan">
								<h3>
									Advanced
									<em class="desc"><strong>5GB</strong> Disk Space</em>
									<span>$29</span>
								</h3>
								<a class="btn btn-primary" href="#">Sign up</a>
							</div>
						...
						<div class="col-lg-2">
							<div class="plan most-popular">
								...
								<h3>
									Professional
									<em class="desc"><strong>15GB</strong> Disk Space</em>
									<span>$39</span>
								</h3>
								<a class="btn btn-primary" href="#">Sign up</a>
							</div>
						...
						<div class="col-lg-2">
							<div class="plan">
								<h3>
									Enterprise
									<em class="desc"><strong>100GB</strong> Disk Space</em>
									<span>$49</span>
								</h3>
								<a class="btn btn-primary" href="#">Sign up</a>
							</div>
