...
<html class="fixed">
	<head>
		...
		<title>Widgets | Porto Admin - Responsive HTML5 Template 2.2.0</title>
	...
	<body>
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						<h4 class="mt-0 mb-0">Block Widgets</h4>
						<p>Block Widgets are perfect to show some statistics.</p>
						
						<div class="row">
							<div class="col-lg-6 col-xl-4">
								<h5 class="font-weight-semibold text-dark text-uppercase mb-3 mt-3">Default</h5>
							...
							<div class="col-lg-6 col-xl-4">
								<h5 class="font-weight-semibold text-dark text-uppercase mb-3 mt-3">Icon Colors</h5>
								<section class="card card-featured-left card-featured-primary mb-4">
									<div class="card-body">
										<div class="widget-summary">
											<div class="widget-summary-col widget-summary-col-icon">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<section class="card card-featured-right card-featured-primary mb-4">
									<div class="card-body">
										<div class="widget-summary">
											<div class="widget-summary-col widget-summary-col-icon">
												<div class="summary-icon bg-primary">
							...
							<div class="col-lg-6">
								<section class="card card-featured-bottom card-featured-primary mb-4">
									<div class="card-body">
										<div class="widget-summary">
											<div class="widget-summary-col widget-summary-col-icon">
												<div class="summary-icon bg-primary">
						...
						<h4 class="mt-3 mb-0">Content Widgets</h4>
						<p class="mb-3">Content Widgets are perfect to show text information.</p>
						
						<div class="row">
							<div class="col-lg-6 col-xl-6">
								<section class="card mt-4">
									<header class="card-header bg-white">
										<div class="card-header-icon bg-primary mt-3">
											<i class="fas fa-rocket"></i>
										</div>
									</header>
									<div class="card-body">
										<h3 class="mt-0 font-weight-semibold mt-0 text-center">Simple Block Title</h3>
							...
							<div class="col-lg-6 col-xl-6">
								<section class="card mt-4">
									...
									<div class="card-body text-center">
										<h3 class="font-weight-semibold mt-3 text-center">Simple Block Title</h3>
										<p class="text-center">Nullam quiris risus eget urna mollis ornare vel eu leo. Soccis natoque penatibus et magnis dis parturient montes. Soccis natoque penatibus et magnis dis parturient montes.</p>
									</div>
								</section>
							</div>
						...
						<div class="row">
							<div class="col-lg-12 col-xl-6">
								<div class="row">
									<div class="col-md-12">
										<h4 class="mt-0 mb-0">User Widgets</h4>
											...
											<div class="widget-twitter-profile">
												...
												<div class="profile-info">
													<div class="profile-picture">
														<img src="img/!logged-user.jpg" alt="">
													</div>
													<div class="profile-account">
														<h3 class="name font-weight-semibold">John Doe</h3>
								...
								<div class="row">
										...
										<section class="card">
											<header class="card-header bg-primary">
												...
												<div class="widget-profile-info">
													...
													<div class="profile-info">
														<h4 class="name font-weight-semibold mb-0">John Doe</h4>
									...
									<div class="col-lg-6">
										<section class="card">
											...
											<div class="card-body">
												<h4 class="font-weight-semibold mt-3">John Doe</h4>
												<p>Nullam quiris risus eget urna mollis ornare vel eu leo. Soccis natoque penatibus et magnis dis parturient montes. </p>
							...
							<div class="col-lg-12 col-xl-6">
											...
											<div class="col-12">
												<section class="card card-featured card-featured-primary mb-4">
													<div class="card-body">
														...
														<div class="row">
															<div class="col-md-4">
																<div class="h4 font-weight-bold mb-0 mt-3">488</div>
																<p class="text-3 text-muted mb-0">Total Sales</p>
															</div>
															<div class="col-md-4">
																<div class="h4 font-weight-bold mb-0 mt-3">$1000</div>
																<p class="text-3 text-muted mb-0">Profit</p>
															</div>
															<div class="col-md-4">
																<div class="h4 font-weight-bold mb-0 mt-3">123</div>
																<p class="text-3 text-muted mb-0">Comments</p>
															</div>
														</div>
													</div>
												</section>
									...
									<div class="col-md-6">
										<div class="row">
											...
											<div class="col-12">
												<section class="card mb-4">
													<div class="card-body">
														<div class="small-chart float-right" id="sparklineBar"></div>
														<script type="text/javascript">
								...
								<div class="row">
									<div class="col-md-12">
										<h4 class="mt-3 mb-0">Misc Widgets</h4>
										<p class="mb-3">Customizable widgets.</p>
						
										<section class="card mb-4">
											<div class="card-body card-body-nopadding">
												<div class="owl-carousel owl-theme mb-0" data-plugin-carousel data-plugin-options='{ "dots": true, "items": 1 }'>
													<div class="item">
														<img alt="" class="img-fluid rounded" src="img/blog-image-3.jpg">
													</div>
													<div class="item">
														<img alt="" class="img-fluid rounded" src="img/blog-image-2.jpg">
													</div>
													<div class="item">
														<img alt="" class="img-fluid rounded" src="img/blog-image-1.jpg">
													</div>
												</div>
												<div class="p-3">
													<h4 class="font-weight-semibold mt-0">Simple Block Title</h4>
													<p>Nullam quiris risus eget urna mollis ornare vel eu leo. Soccis natoque penatibus et magnis dis parturient montes. Urna mollis ornare vel eu leo. Soccis natoque penatibus et magnis dis parturient montes. Soccis natoque penatibus et magnis dis parturient montes.</p>
												</div>
											</div>
											<div class="card-footer card-footer-btn-group">
												<a href="#"><i class="fas fa-user mr-1"></i> My Profile</a>
												<a href="#"><i class="fas fa-lock mr-1"></i> Lock Screen</a>
												<a href="#"><i class="fas fa-power-off mr-1"></i> Logout</a>
											</div>
										</section>
									</div>
								</div>
		...
		<!-- Examples -->
		<script src="js/examples/examples.widgets.js"></script>
	</body>
</html>